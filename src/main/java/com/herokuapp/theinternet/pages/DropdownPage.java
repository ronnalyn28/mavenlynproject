...
public class DropdownPage extends BasePageObject {
	...
	public void selectOption(int i) {
		...
		// There are three ways to use Select an option
		// #1 dropdown.selectByIndex(i);

		// #2
		dropdown.selectByValue("" + i); //converting int value fr selectOption to String

		// #3 dropdown.selectByVisibleText("Option " + i);
	}
