...
public class JSAlertsPage extends BasePageObject {
	...
	public void openJSAlert() {
		log.info("Clicking the 'Click for JS Alert' button to open alert");
	...
	public void openJSConfirm() {
		log.info("Clicking the 'Click for JS Confirm' button to open alert");
		click(clickForJSConfirmButtonLocator);
	}

	/** Clicking on 'Click for JS Prompt' button to open alert */
	public void openJSPrompt() {
		log.info("Clicking the 'Click for JS Prompt' button to open alert");
